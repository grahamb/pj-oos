...
const countFreePeriodsForUnit = require('../scheduleHelpers/countFreePeriodsForUnit.js');
...
const createScheduleForUnit = Promise.coroutine(function* (u, i) {
  ...
  if (countFreePeriodsForUnit(unit) === 3) {
    console.log('Unit already has two free periods');
    return u;
  }
